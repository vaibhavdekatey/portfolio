  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className="flex flex-col md:mr-0 mr-28">
            <div className="  text-txt_primary flex flex-row items-end align-text-bottom text-2xl font-robotoMono mb-8 border-slate-700 mr-7 ">
              ...
              <p className="text-slate-300 lg:text-4xl px-3 font-poppins font-bold mt-[1px] md:text-2xl flex">
                Where I've Worked
              </p>
            ...
            <div className="flex flex-row">
              <div>
                {experience.map((work, index) => (
                  <p
                    ...
                    className={`${
                      active === index
                        ? `text-txt_primary border-txt_primary border-l-2 transition ease-in`
                        : `text-slate-400 border-slate-500 border-l-2`
                    } mr-8 font-robotoMono text-sm hover:text-txt_primary hover:border-l-2 w-[180px] hover:border-txt_primary hover:bg-txt_primary/10 h-[44px] items-center justify-center flex transition ease-in`}
                  >
                    {work.where}
                  </p>
                ))}
              ...
              <div className="flex-col flex text-xl text-slate-400 transition-opacity opacity-100 duration-700 ease-in">
                <p className="text-xl text-slate-400 font-poppins md:flex-col font-medium flex lg:flex-row">
