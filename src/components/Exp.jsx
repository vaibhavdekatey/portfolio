...
function Exp() {
  ...
  return (
    <>
      <div
        id="Exp"
        className="md:min-h-[700px] w-screen bg-primary flex flex-col items-center "
      >
        <motion.div
          ...
          className="mx-[24vw] sm:mx-[18vw] md:mt-16  md:mb-56 w-[75vw] flex justify-center"
        >
          <div className="flex flex-col sm:mr-0 lg:mr-28 ">
