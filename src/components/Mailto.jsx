...
function Mailto() {
  return (
    <div className="sm:hidden md:flex mailto flex-row flex fixed bottom-[-1rem] right-[2.5rem] mb-4 mr-4 rotate-90 origin-bottom-right text-2xl font-robotoMono text-txt_primary  hover:text-white z-10 bg-transparent transition ease-in">
      <a
