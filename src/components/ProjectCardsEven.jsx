    ...
    <>
      <div className=" Even lg:flex-row-reverse sm:flex-col flex sm:w-[75vw] md:w-full lg:justify-between sm:items-center mb-[60px] ">
        <a
          href={props.link}
          target="_blank"
          className="flex flex-col lg:min-w-[440px] lg:min-h-[260px] lg:mr-5 lg:-translate-x-11 cursor-pointer"
        >
          <img
            src={props.img_src}
        ...
        <div className="md:min-w-[640px] flex flex-col  justify-center sm:items-end z-10">
          ...
          <div className="flex-row flex m-2 sm:-translate-y-12">
            ...
            <a href={props.link} target="_blank">
              <svg
                ...
                height="26"
                fill="currentColor"
                className="globe2 text-slate-400 hover:text-txt_primary transition ease-in"
                viewBox="0 0 16 16"
              >
...
export default ProjectCardsEven;
